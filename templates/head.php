...
<head>
    ...
    <!-- FAVICON -->
    <link rel="apple-touch-icon" sizes="57x57" href="<?php echo $path; ?>images/favicon/apple-icon-57x57.png">
    ...
    <meta name="msapplication-TileImage" content="<?php echo $path; ?>images/favicon/ms-icon-144x144.png">
